...
<body>
  ...
  <div class="ad-banner">
    ENJOY UP TO 50% OFF SELECTED TOYS | <a href="deals-disc.php">SHOP SALE</a>
  </div>
  ...
  <header class="main-header">
    ...
    <div class="menu-actions">
      ...
      <!-- login -->
      <?php if (isset($_SESSION['user_id'])): ?>
          <a href="logout.php" class="menu-icon" title="Logout"><i class="fas fa-user"></i></a>
      <?php else: ?>
  ...
  <div class="page-container">
    ...
    <main>
      ...
      $sql = "SELECT * FROM products WHERE page='products-kchains.php' AND is_published = 1 ORDER BY id DESC";
      $result = $conn->query($sql);

      // to-do: fix formatting issues
